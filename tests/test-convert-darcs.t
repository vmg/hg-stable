
copy: tests/test-convert-darcs
copyrev: 2d04a9672128d558e4aa8966561a30d082189af6

...
darcs is encoding agnostic, so it takes whatever bytes it's given
  ...
  $ darcs record -a -l -m 'p4: desc Ã±' -A 'author Ã±'
  Finished recording patch 'p4: desc Ã±'
...
Test latin-1 commit message
  ...
  Finished recording patch 'p5: desc €‚ƒ„…†‡ˆ‰Š‹ŒŽ‘’“”•–—˜™š›œžŸ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ'
